...
train.labels = tbl_dt(fread("../data/0bf8bc6e-30d0-4c50-956a-603fc693d966.csv",
                            na.strings = na.strings,
                            colClasses = c("integer","character")))
train.values = tbl_dt(fread("../data/4910797b-ee55-40a7-8668-10efd5c1b960.csv",
                            na.strings = na.strings,
                            colClasses = colClasses))
test.values = tbl_dt(fread("../data/702ddfc5-68cd-4d1d-a0de-f5f566f76d91.csv",
                           na.strings = na.strings,
                           colClasses = colClasses))
